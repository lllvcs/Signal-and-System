function helpwin(titleStr,helpStr1,helpStr2,helpStr3);
% HELPWIN Utility function for displaying help text conveniently.

numPages=3;

if nargin<4 | isempty(helpStr3),
   helpStr3=' ';
   numPages=numPages-1;
end;
if nargin<3 | isempty(helpStr2),
   helpStr2=' ';
   numPages=numPages-1;
end;
...
[existFlag,figNumber]=figflag('实验教学系统信息窗',1);

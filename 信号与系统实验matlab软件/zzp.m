function zzp(ttlStr,helpStr1,helpStr2,helpStr3);
% helpwx Utility function for displaying help text conveniently.
...
[existFlag,figNumber]=figflag('图像处理系统信息窗',1);
